...
if (appNodes.fullscreenFormOption && !fullscreenEnabled()) {
...
function handleKeydown(event) {
	...
	// O
		...
		// 'O' key used to toggle menu, now disabled.
	}
}
...
document.addEventListener('DOMContentLoaded', () => {
	soundManager.preload()
		.then(
			init,
			// Ignore audio loading errors and initialize anyway
			init
		);
});
